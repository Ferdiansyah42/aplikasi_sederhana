...
<body class="hold-transition sidebar-mini">
    ...
    <!-- jQuery -->
    <script src="{{ asset('/templateplugins/jquery/jquery.min.js')}}"></script>
    <!-- Bootstrap 4 -->
    <script src="{{ asset('/templateplugins/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
    <!-- AdminLTE App -->
    <script src="{{ asset('/templatedist/js/adminlte.min.js')}}"></script>
